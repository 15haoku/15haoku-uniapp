...
<script>
	...
	export default {
		...
		data() {
			this.dataConfig.logoConfig.url = "/static/images/logo.png"
			this.dataConfig.listConfig.list = [
                        {
                            "chiild": [
                                {
                                    "title": "【重要】关于15号库公众号迁移通知",
                                    "val": "【重要】关于15号库公众号迁移通知",
                                    "max": 30,
                                    "pla": "选填，不超过30个字",
                                    "empty": "1"
                                },
                        ...
                        },
                        {
                            "chiild": [
                                ...
                                {
                                    "title": "链接",
                                    "val": "/pages/activity/lifeService/index",
                                    "max": 200,
                                    "pla": "请输入连接"
                                }
                            ]
